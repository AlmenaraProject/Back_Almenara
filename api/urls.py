...
routers.register(r'carrera', CarreraViewSet)
routers.register(r'facultad', FacultadViewSet)
routers.register(r'asignatura', AsignaturaViewSet)
routers.register(r'campo-clinico', CampoClinicoViewSet)
...
routers.register(r'profesional-pregrado', ProfesionalPregradoViewSet)
